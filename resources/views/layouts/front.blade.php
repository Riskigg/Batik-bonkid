...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,400;1,700&display=swap"
        rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,800;1,800&display=swap"
        rel="stylesheet">
        ...
        <div class="container p-0">
            <nav class="navbar navbar-expand-md">
                <a class="navbar-brand" href="index.html"><img class="img-fluid"
                        src="{{ asset('images/logo-bonkid.png') }}" alt="logo afn group"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ route('index') }}">@lang('content.nav1')</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('products') }}">@lang('content.nav2')</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('login') }}">@lang('content.nav3')</a>
                        </li>
                    </ul>
                    <form class="form-inline my-lg-0" action="{{ route('index') }}" method="GET">
                        <div class="d-md-none d-sm-block mb-3">
                            <input name="keyword" class="form-control mr-sm-2 br10" type="text"
            ...
            <div class="item search right" tabindex="0">
                <form class="form-inline my-lg-0" action="{{ route('index') }}" method="GET" style="width:80%">
                    <div class="search-group">
                        <input type="text" name="keyword" placeholder="@lang('content.search')"><i
                            class="fas fa-search material-icons search-icon"></i>
                    </div>
                </form>
            </div>
